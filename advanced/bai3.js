 ...
 *  - Thực hiện:
 *      + Gọi ra một promise => sẽ tạo ra một hàng đợi ngay lập tức (Job queue)
 *      + Thực hiện hàm bất đồng bộ trước khi promise trả về resolve
 *      + Thực thi công việc ở trong hàm đợi nếu việc ScriptJob hiện tại kết thúc.
 */

const controller_1 = async (req, res) => {
  functionA();
